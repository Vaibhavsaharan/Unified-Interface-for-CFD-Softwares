...
# filelist = [f.name for f in os.scandir() if f.is_file()]
filelist = glob.glob("2dtank/post-processing/*[0-9].vtu")
print(filelist)
#os.chdir(currentdir)
...
results = fluidity_tools.stat_parser("2dtank/post-processing/water_collapse.detectors")
